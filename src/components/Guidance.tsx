...
import { Facebook, Instagram, Languages, LogInIcon, LogOutIcon, Twitter } from 'lucide-react';
...
const ServicesLinks = () => (
  <>
    <Link href="/search" className="hover:scale-110 transition-transform">For You</Link>
    <Link href="/search" className="hover:scale-110 transition-transform">Couples</Link>
    <Link href="/search" className="hover:scale-110 transition-transform">Families</Link>
  </>
);
...
const AboutLinks = () => (
    <>
        ...
        <GradientButton>Join as a psychologist</GradientButton>
        <Button
            variant="outline"
  ...
  return (
      ...
      >
          <div className="flex flex-col gap-2 font-openSans text-white">
              <SocialMediaLinks />
              <Link href={"/"} className="font-playfairDSC text-3xl uppercase">
                  Profypsy
              </Link>
